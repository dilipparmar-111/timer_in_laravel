<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="{{url('/home')}}"><i data-feather="home"></i><span>@lang('menubar.dashboard')</span></a></li>

            <li><a class="nav-link" href="{{url('/users')}}"><i data-feather="user"></i><span>@lang('menubar.users')</span></a></li>
